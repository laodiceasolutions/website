        ...
        <div tw="bg-gray-50 flex">
          <div tw="flex md:flex-row w-full py-12 px-4   items-center justify-center p-8">
            <h2 tw="flex flex-col text-3xl sm:text-4xl font-bold tracking-tight text-gray-900" style={{ fontFamily: "Montserrat" }}>
              ...
              {
                (!language || language === 'tr') ? (<>Yazılımınızı <span tw="font-extrabold text-[#60CE70] whitespace-nowrap">{'{ }'}</span><br /> birlikte geliştirelim!</>) : (<>Lets make <span tw="font-extrabold text-[#60CE70] whitespace-nowrap">{'{ }'}</span> <br /> software together!</>)
              }
