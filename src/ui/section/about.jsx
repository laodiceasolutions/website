...
export default function About() {
  ...
  return (
    <section className="relative min-h-screen w-full scroll-mt-24 grid grid-cols-12 gap-8 container mx-auto px-4 py-20 md:py-24" id="about">
      ...
      <div className="absolute top-5">
        <h2 className="text-4xl md:text-5xl text-laodicea-secondary font-extrabold">{dictionary.landingPage.header.navbar.about}</h2>
      </div>
